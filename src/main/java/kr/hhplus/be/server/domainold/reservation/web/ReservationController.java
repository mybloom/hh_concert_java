package kr.hhplus.be.server.domainold.reservation.web;
...
import kr.hhplus.be.server.domainold.reservation.domain.ReserveService;
import kr.hhplus.be.server.domainold.reservation.domain.SeatService;
import kr.hhplus.be.server.domainold.reservation.domain.dto.ReservationRequest;
import kr.hhplus.be.server.domainold.reservation.domain.dto.ReservationResponse;
...
public class ReservationController {
    ...
    public ReservationResponse reserveSeat(@RequestBody ReservationRequest request) {
        ReservationResponse response = reserveService.reserve(request);
        return response;
    }
